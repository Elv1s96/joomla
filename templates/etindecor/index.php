        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, default.css') // CSS Files
                        ->addJS('bootstrap.min.js, jquery.sticky.js, main.js, wow.min.js, custom.js, jquery.easing.min.js') // JS Files
				...
				<?php require_once(dirname(__FILE__) .'/css/system.php'); ?>
                    ...
                    <?php } ?>
                    <div align="center"><a target="_blank" href="http://joomla3x.ru/" title="joomla 3">joomla3x</a></div>
                </body>
                </html>
